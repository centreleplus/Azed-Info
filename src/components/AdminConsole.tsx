              ...
              >
                ...
                <footer className="bg-[#0047AB] text-slate-300 py-8 px-6 text-center text-xs space-y-4" style={{ backgroundColor: formPrimary }}>
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 max-w-4xl mx-auto">
                    <div className="flex items-center gap-2">
                      <span className="w-6 h-6 rounded bg-white text-[#0047AB] flex items-center justify-center font-bold text-xs" style={x�|S�j�0��+SH��@O��bB{)9�ҖB�x�
d�H��u�A����j�I�K�A,;�#�.`*������$M�̡,,0|�	|�n�j��SF�z!)�v"�v?�A�J���n��h���h�U���Eaf ��C�R�7���ĔφU�0{�H�*a@UV�6<B�{
%MZ`��S�����#��8+k�p�nI���4@�ȶW���zv�a�<�I�Z��Ӆ�������O1�ѽ�tl�S6Pp\ "�o�z8g��l;���\A,�
����:=�����?B�<E.��Z��
M����~����8���O���7ʴ���UZ�2!5�)�}��`eoĘ�9�Gp��  �� ���