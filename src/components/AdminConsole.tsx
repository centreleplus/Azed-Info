              ...
              >
                ...
                <footer className="bg-[#0047AB] text-slate-300 py-8 px-6 text-center text-xs space-y-4" style={{ backgroundColor: formPrimary }}>
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 max-w-4xl mx-auto">
                    <div className="flex items-center gap-2">
                      <span className="w-6 h-6 rounded bg-white text-[#0047AB] flex items-center justify-center font-bold tx�|S�N�0��+VR�$��	PEU��� ��fS,9vd������c8M�
�냵����ȸ2�JЦ��%L%��R���bUT�m��@�P�T���'�S��h�1I�0���	����z�ꭉ�� q��%9+ j�!�/�H&fC��8���8-R���mL����KШX��=�ț�]|�2!忶�Ʃ���h�PU�m����� ��@��&�(RI\T缌-P~h�ξ��>ͩA���%�Q�6P
\��v�`�f8����x���\C�$3����pa��� ?5�CX�RT���G�(̤aR���ڣ�/�38R�QL���_TY{7���  �� ^���